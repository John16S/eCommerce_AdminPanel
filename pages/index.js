            ...
            <div className={"bg-gradient-to-r from-[#4F6096] to-[#8085B8] min-h-screen bg-bottom bg-no-repeat bg-fixed"}>
                ...
                <div className="flex items-center justify-between p-6">
                    <a href="#" className="flex items-center gap-2">
                        ...
                        <span className="text-xl fgit ont-black">Security</span>
                    </a>
                    {/* **********************************Sign In********************************* */}
                    <div>
                        <a href="#"
                ...
                {/*******************************BLock forms*******************************/}
                <div className="bg-white/40 backdrop-blur-lg mt-3 mx-auto rounded-xl shadow-xl p-5 max-w-sm w-full flex-col justify-center">
