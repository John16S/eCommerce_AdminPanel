...
export default function Home() {
  return (
      <div className={"bg-gradient-to-r from-[#4F6096] to-[#8085B8] min-h-screen bg-bottom bg-no-repeat bg-fixed"} style={{ backgroundImage: `url(${img})`}}>
      {/* **********************************Body********************************* */}
              ...
              <div
                  ...
                  <form action="#" className="space-y-3">
                      ...
                      <div className={'flex items-center justify-between'}>
                          ...
                          <button className="rounded-md bg-blue-700 py-2 px-4 mt-3 text-white font-semibold shadow-lg hover:shadow-xl focus:shadow-xl hover:bg-blue-900 transition duration-200 ease-in-out">
                              Login with Google
                          </button>
                      </div>
                  </form>
